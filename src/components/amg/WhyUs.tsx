  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-2">
        <span className="flex size-12 items-center justify-center rounded-full border border-white/15 bg-black/30 text-muted-foreground">
  ...
  return (
    <section id="why-us" className="relative overflow-hidden border-y border-border py-16 md:py-24">
      <div
        ...
        style={{
          backgroundImage:
            "radial-gradient(ellipse 70% 50% at 80% 40%, oklch(0.57 0.235 27.5 / 0.12), transparent 60%)",
        }}
        aria-hidden
      />
        ...
        <div className="mt-10 grid items-center gap-10 lg:mt-14 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-14">
          ...
          <Reveal delay={160} variant="right" className="mx-auto w-full max-w-md lg:max-w-none">
            <div className="relative mx-auto aspect-[4/5] w-full max-w-[420px] lg:ml-auto lg:mr-0">
              <div className="absolute right-0 top-0 h-[72%] w-[78%] overflow-hidden border border-white/10">
                <PhotoSlot src={whyUsPhoto2} alt="Jeep Wrangler после детейлинга AMG" />
              </div>
              <div className="absolute bottom-0 left-0 h-[48%] w-[72%]">
                <div
                  ...
                  aria-hidden
                />
                <div className="relative size-full overflow-hidden border border-white/15">
                  <PhotoSlot
                    src={whyUsPhoto1}
                    alt="Porsche и Bentley в студии AMG Detailing"
